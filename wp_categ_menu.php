...
Description: Works as a widget. Displays a menu(list or select field) based on posts categories/pages(also for custom post types and custom taxonomies).
...
?>
  ...
  ?>   
    ...
    <br />
    <label for="wpcmenu-WidgetSubc">Display subcategories(one level): </label><br />
